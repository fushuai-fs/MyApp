...
public class HttpConnProp {
    ...
    public void setIsKeepAlive(boolean isKeepAlive) {
        this.IS_KEEP_ALIVE = isKeepAlive;
    }
    ...
    public void setISUseCaches(boolean ISUseCaches) {
        this.IS_USE_CACHE = ISUseCaches;
    }
    ...
    public void setIsInstanceFollowRedirects(boolean ISInstanceFollowRedirects) {
        this.IS_INSTANCE_FOLLOW_REDIRECTS = ISInstanceFollowRedirects;
    }
